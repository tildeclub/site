...
<!-- Tildeverse Banner Exchange code begin -->
	<CENTER>
		...
		<br><a href="https://banner.tildeverse.org" target="_blank">Tildeverse Banner Exchange</a>
	</CENTER>
<!-- Tildeverse Banner Exchange code begin -->
	<br><br>
	    <p>ECDSA fingerprint: SHA256:duamOATgnGcfRFFkotCwrAWzZtRjwxm64WAhq5tQRwE</p>
            <a href="https://github.com/tildeclub/site">page source</a> | <a href="https://status.tilde.one/status/tildeclub">Services Status</a>
		</footer>
	</body>
</html>
